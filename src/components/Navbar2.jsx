    ...
    return (<>
        ...
        {/* cart */}
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                {/* cart */}
                    <NavLink class="nav-item nav-link pro" href="#" className="pro carts" to="/login" style={{ "color": "white", "fontSize": "30px", "fontWeight": "400",      "listStyle":"none","margin-top":"2px", "padding":"5px", "background-color":"#e67e22", "width":"130px", "text-align": "center", "height": "50px", "border-radius": "5px" }}>
                    ...
                    <Link to="/login" style={logstyle}>
                        <div className="login_button" class=" login_button">
                            <span className="logtxt">LOGOUT</span>
                        </div>
                    </Link>
                </div>
            </div>

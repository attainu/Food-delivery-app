    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-dark">
                ...
                <h2 className="material-icons" style={{ "fontSize": "45px", "textDecoration": "none", "marginLeft": "4%", "marginRight": "1vw", "paddingTop": "0.5rem" }}>emoji_food_beverage
            </h2>

                <Link className="navbar-brand react" to="/" style={{ "fontSize": "45px", "fontWeight": "600", "marginRight": "35%", "textDecoration": "none" }}> Foodifly</Link>
                ...
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <a href="/login" style={{ "color": "white", "marginLeft": "1rem" }} > <span className="logtxt"></span> Login</a>
                    <a href="/signup" style={{ "color": "white", "marginLeft": "1rem" }} ><span className="logtxt">Signup</span> </a>
